...
<html lang="en">
  ...
  <div class="container">
    ...
    <div class="collapse navbar-collapse" id="navbarNavDropdown">
      ...
      <a href="signUp.php" class="btn btn-success me-2">Авторизацоваться</a>
      ...
      <div class="col-md-8 mt-5">
        <form class="p-md-4 border rounded-3 bg-light justify-content-center" id="form" action="./vendor/logIn.php" method="post" enctype="multipart/form-data">
          <h3 class="mb-2">У вас появился вопрос предложение или претензия?</h3>
          <div class="mb-2">
            <label for="floatingInput" class="mb-2">Введите ваше имя</label>
            <input type="text" class="form-control" name="fullname" id="floatingPassword">
          </div>

          <div class="mb-3">
            <label for="floatingPassword" class="mb-2">Введите ваше сообщение</label>
